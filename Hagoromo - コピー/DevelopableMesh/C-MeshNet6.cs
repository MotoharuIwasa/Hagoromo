...
{
    public class MeshNet6 : GH_Component
    {
        public MeshNet6()
          : base("MeshNet6", "MeshNet6",
              "NeshNet46",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            CutMesh newMesh = NetTools.NetBFFandCGLength(mesh);
        ...
        {
            get { return new Guid("70C1DA3E-3549-4A8B-AF4F-A5809AF59994"); }
        }
    }
}