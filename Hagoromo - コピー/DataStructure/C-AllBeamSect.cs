...
{
    public class AllBeamSect : GH_Component
    {
        public AllBeamSect()
          : base("All Beam Section Info", "AllBeamSect",
        ...
        {
            pManager.AddGenericParameter("Beam Sectdata", "s", "List of Sectdata", GH_ParamAccess.list);
        }

        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            pManager.AddGenericParameter("AllBeamSectdata", "S", "Combined section data", GH_ParamAccess.item);
