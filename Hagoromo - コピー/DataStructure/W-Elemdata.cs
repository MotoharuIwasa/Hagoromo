...
{
    public class GH_Elemdata : GH_Goo<BeamElem.Elemdata>
    {
        public GH_Elemdata() : base() { }
        public GH_Elemdata(BeamElem.Elemdata elemdata) : base(elemdata) { }

        public override IGH_Goo Duplicate()
        {
            return new GH_Elemdata(new BeamElem.Elemdata(
                Value.SectId,
        ...
        {
            if (source is BeamElem.Elemdata elemdata)
            {
                Value = elemdata;
                return true;
            }
        ...
        {
            if (typeof(Q).IsAssignableFrom(typeof(BeamElem.Elemdata)))
            {
