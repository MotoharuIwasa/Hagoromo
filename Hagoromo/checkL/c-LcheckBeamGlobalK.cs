...
{
    public class LCheckBeamGlobalK : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public LCheckBeamGlobalK()
          : base("LCheckBeamGlobalK", "LCheckBeamKg",
              "グローバル剛性マトリクス",
              "Hagoromo", "Linear")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double[,] matrix = LinearK.MakeGlobalK(falldata);
        ...
        {
            get { return new Guid("C2FD7D57-017F-4B5E-9EDF-33BC97D97F3A"); }
        }
    }
}