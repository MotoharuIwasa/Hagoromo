...
namespace Hagoromo.DevelopableMesh
{
    public static class CurvatureTools
    {
        ...
        /*
        public static double ObjectiveCalc(CutMesh cutMesh, double[] angleSum, List<List<List<int>>> category, double w1, double w2, double w3)
        {
