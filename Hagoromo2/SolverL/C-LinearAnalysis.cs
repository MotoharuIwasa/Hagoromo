...
namespace Hagoromo.SolverL
{
    ...
    public class BeamLinearAnalysis : GH_Component
    {
        ...
        public BeamLinearAnalysis()
          : base("BeamLinear Analysis", "BeamLA",
              "solved by linear analysis for beams.重力は両節点に半分ずつ分配しモーメントは考えない。" +
