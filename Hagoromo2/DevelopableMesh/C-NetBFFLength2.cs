...
namespace Hagoromo.DevelopableMesh
{
    public class NetBFFLength2 : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("OuterBoundaryVertCount", "C", "OuterBoundaryVertCount", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (curves.Count == 0)
            {
                CutMesh newMesh2 = NetTools.NetBFFandCGLength(cutMesh, outerBoundaryVertCount);
            ...
            CutMesh newMesh = NetTools.NetBFFandCGLength(cutMesh, outerBoundaryVertCount);
