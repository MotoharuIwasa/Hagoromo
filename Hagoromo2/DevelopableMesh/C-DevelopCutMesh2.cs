...
namespace Hagoromo.DevelopableMesh
{
    public class DevelopCutMesh2 : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // 以降 cutMesh が確実に利用可能
            CutMesh newMesh = CurvatureTools.CGDevCutMeshConsiderOther(cutMesh, iterations, alpha, xyMirror, yzMirror, zxMirror, sortedOuterVertIndices, sortedFixVertIndices);
