...
{
    public class CheckObjective : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MyComponent1 class.
        /// </summary>
        public CheckObjective()
          : base("CheckObjective", "CheckObjective",
              "CheckObjective",
        ...
        {
            pManager.AddNumberParameter("f", "f", "objective value", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double[] angleSum = CutMeshCalcTools.AngleSum(cutMesh);
            double f = CurvatureTools.ObjectiveCalc(duplicatedVertIndices, vertices, angleSum, category);
            DA.SetData(0, f);
        ...
        {
            get { return new Guid("BB20F89A-54DA-415B-A101-C39C52B3BC67"); }
        }
    }
}