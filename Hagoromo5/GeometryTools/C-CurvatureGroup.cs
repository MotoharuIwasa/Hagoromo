...
namespace Hagoromo.GeometryTools
{
    public class CurvatureGroup : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("count", "c", "cluster cout", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            int startIndex = clusters[2][0];
            int endIndex = clusters[2][0]; ;
            int thirdIndex = clusters[2][0]; ;
            ...
            path.AddRange(path2);
            CutMesh newMesh = MeshCutTools.CutMeshWithEdgeIndices(cutMesh, path2);
            DA.SetData(1, new GH_CutMesh(newMesh));
            DA.SetData(2, clusters.Count);
        }
