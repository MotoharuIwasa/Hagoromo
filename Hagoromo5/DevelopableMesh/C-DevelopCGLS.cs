...
namespace Hagoromo.DevelopableMesh
{
    public class DevelopCGLS : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            int smoothCrvIndex = pManager.AddCurveParameter("smoothing polylines", "smoothCrv", "each smoothing polyline should be joined", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            bool hasInput2 = DA.GetDataList(8, unSmoothCrvs);
            List<int> sortedUnSmoothVertIndices = CrvToVertIndices(cutMesh, unSmoothCrvs);

            List<Curve> smoothCrv = new List<Curve>();
            bool hasInput3 = DA.GetDataList(14, smoothCrv);
            ...
            List<List<List<int>>> category = CategolizeMulti(cutMesh, xyMirror, yzMirror, zxMirror);
            ...
            */
            foreach (int i in sortedOuterVertIndices)
            {
                int id = vertOrderInDup[i] * 3;
                unMoveSetSmooth.Add(id);
                unMoveSetSmooth.Add(id + 1);
            ...
            List<List<int>> dupVerts = CrvToDupVertIndices(cutMesh, smoothCrv);

            //w1～w6の設定
            //double[] w = new double[] { 100.0, 100.0, 0.0, 100.0, 100.0, 100.0 };
            ...
            optimizer.AddTerm(new BoundarySmoothCGLS(smoothW, unMoveSet, dupVerts));
