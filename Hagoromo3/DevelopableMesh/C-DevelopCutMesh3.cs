    ...
    public class DevelopCutMesh3 : GH_Component
    {
        public DevelopCutMesh3()
          : base("Develop CutMesh3", "DevelopCM3",
              "CGによる可展面近似。ミラー、切込みに対応している。Jacobiでセルフのみ考慮。DevCM2よりは性能いい",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // 以降 cutMesh が確実に利用可能
            CutMesh newMesh = CGDevCutMeshConsiderJustSelf(cutMesh, iterations, alpha, xyMirror, yzMirror, zxMirror, sortedOuterVertIndices, sortedFixVertIndices);
