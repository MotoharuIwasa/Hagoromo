...
{
    //制約条件なしでエッジの長さの最適化による展開図。
    public class MeshNet : GH_Component
    {
        public MeshNet()
          : base("MeshNet", "MeshNet",
              "Description",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            while (iterations < c)
            {
                ...
                NetTools.NetCGLength(Jacobi, p, connectedVertices, initialLength, newTopoVertices2D);
                iterations += 1;
            }
        ...
        {
            get { return new Guid("B1991716-0DA9-45EB-8368-AF44A7D97E35"); }
        }
    }
}